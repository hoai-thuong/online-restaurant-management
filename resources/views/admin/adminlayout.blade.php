  ...
  <body>
    <div class="container-scroller">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        ...
        @if(Auth::user()->usertype != 2)
          <a class="sidebar-brand brand-logo" href="/redirects" style="color:white;text-decoration:none;">Quản lý</a>
        @endif
        @if(Auth::user()->usertype == 2)
          <a class="sidebar-brand brand-logo" href="/redirects" style="color:white;text-decoration:none;">Trang chủ shipper</a>
        @endif
        ...
        <ul class="nav">
          ...
          @if(Auth::user()->usertype != 2)
          <li class="nav-item"> <a class="nav-link" href="/admin/orders-incomplete">Chưa xác nhận</a></li>

@endif

                <li class="nav-item"> <a class="nav-link" href="/orders/process">Đang vận chuyển</a></li>
                <li class="nav-item"> <a class="nav-link" href="/orders-complete">Hoàn thành</a></li>
                <li class="nav-item"> <a class="nav-link" href="/orders/cancel">Huỷ</a></li>
        ...
        @endif
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="/admin/customize">
              ...
              <span class="menu-title">Giao diện Landing</span>
            </a>
          </li>
          <li class="nav-item menu-items">
            ...
            <div class="collapse" id="ui-basic2">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="/admin/add/banner">Thêm Banners</a></li>
                <li class="nav-item"> <a class="nav-link" href="/admin/banner/all">Tất cả Banners</a></li>
              </ul>
            </div>
          </li>
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="/delivery-boy">
              ...
              <span class="menu-title">Người giao hàng</span>
            </a>
          </li>
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="/admin/charge">
              ...
              <span class="menu-title">Phụ phí</span>
            </a>
          </li>
