                ...
                <div class="col-lg-4">
                    <div class="left-content">
                        <div class="inner-content">
                            <h3>Nhà Hàng HT</h3>
                            <h4>Trải nghiệm tốt nhất</h4>
                            <div class="main-white-button scroll-to-section">
                                <a href="#reservation"><h2>Đặt bàn ăn</h2></a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 offset-lg-4 text-center">
                    <div class="section-heading">
                        <h6>Tuần lễ HT</h6>
                        <h2>Ưu đãi bữa ăn đặc biệt trong tuần này</h2>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="row" id="tabs">
                                ...
                                <div class="row">
                                    <div class="col-lg-6 offset-lg-3">
                                        <ul>
                                          ...
                                          <li><a href='#tabs-1'><img src="{{ asset('assets/images/tab-icon-01.png')}}" alt="">Bữa sáng</a></li>
                                          <li><a href='#tabs-2'><img src="{{ asset('assets/images/tab-icon-02.png')}}" alt="">Bữa trưa</a></a></li>
                                          <li><a href='#tabs-3'><img src="{{ asset('assets/images/tab-icon-03.png')}}" alt="">Bữa tối</a></a></li>
                        ...
                        <div style="text-align:center;" class="col-lg-12">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="row">
                                                <div class="right-list">
                                                    <div class="col-lg-12">
                                                        <div class="tab-item" style="padding:15px">
                                                            <img src="{{ asset('assets/images/'.$item->image)}}" alt="">
                                                            <h4>{{ $item->name }}</h4>
                                                            <p>{{  $item->description }}</p>
                                                            <div class="price">
                            ...
                            class="btn" type="submit" value="Xem tất cả"></a>
                        </div>
                    </div>
                </div>
            </div>
...
<section class="section"  id="menu">
        <div class="container">
            <div class="row">
                <div class="col-lg-4">
                    <div class="section-heading" >
                        <h6>Thực đơn của chúng tôi</h6>
                        <h2>Chất lượng đến từ hương vị</h2>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="owl-menu-item owl-carousel" >
                    ...
                    ?>
                        <div class='card' style="background-image: url({{asset('assets/images/'.$img)}})"> 
                            ...
                            <div class="price"><h6> {{ number_format($product->price, 0, ',', '.') }} </h6>
      ...
      <br>
                                ...
                                @if($product->available!="Stock")
                                  <form method="post" action="{{route('cart.store',$product->id)}}">
                                     @csrf
                                  <input type="number" name="number" style="width:50px;" id="myNumber" value="1">
                                    <input type="submit" class="btn btn-success" disabled value="Thêm vào giỏ hàng">
                                  </form>
                                @endif
                                </div>
                              </div>
    ...
    <section class="section" id="chefs">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 offset-lg-4 text-center">
                    <div class="section-heading">
                        <h6>Đầu bếp đạt chuẩn chất lượng cao</h6>
                        <h2>Chúng tôi đem lại những bữa ăn thơm ngon cho khách hàng</h2>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-6 align-self-center">
                    <div class="left-text-content">
                        <div class="section-heading">
                            ...
                            <h2>Đặt bàn ăn tại đây</h2>
                        </div>
                        <p>Nhân sự của nhà hàng HT luôn sẵn sàng phản hồi điện thoại của bạn</p>
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="phone">
                            ...
                            <div class="col-lg-6">
                                <div class="message">
                                    ...
                                    <h4>Email</h4>
                                    <span><a href="mailto:adminHUSVNU@gmail.com">HUS@gmail.com</a><br>
									<a href="mailto:adminHUSVNU@gmail.com">HUS@gmail.com</a><br>
									</span>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6 col-sm-12">
                              <fieldset>
                                <select value="number-guests" name="no_guest" id="number-guests">
                                    <option value="number-guests">Lượng khách</option>
                            ...
                            <div class="col-md-6 col-sm-12">
                              <fieldset>
                                <select value="time" name="time" id="time">
                                    ...
                                    <option name="Breakfast" id="Breakfast">Bữa sáng</option>
                                    <option name="Lunch" id="Lunch">Bữa trưa</option>
                                    <option name="Dinner" id="Dinner">Bữa tối</option>
                                </select>
                              </fieldset>
                            </div>
                            <div class="col-lg-12">
