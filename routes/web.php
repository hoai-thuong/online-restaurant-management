...
use App\Http\Controllers\VnPayReturnController;

// Route::post('/vnpay/payment', [VNPayController::class, 'createPayment'])->name('vnpay.payment');
// Route::get('/vnpay/return', [VNPayController::class, 'vnpayReturn'])->name('vnpay.return');
use App\Http\Livewire\LogoutOtherBrowserSessions;


Route::post('/vnpay-payment', [VNPayController::class, 'vnpay_payment']);
...
Route::post('/pay-via-ajax', [VNPayController::class, 'payment'])->name('vnpay.payment');
Route::get('/vnpay/callback', [VNPayController::class, 'callback'])->name('vnpay.callback');

// routes/web.php
Route::post('/payment/process', [VNPayController::class, 'processPayment'])->name('payment.process');
