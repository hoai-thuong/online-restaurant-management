...
class HomeController extends Controller
{
    ...
    public function redirects(){
        ...
        if($usertype!='0')
    	{
            ...
            $pending_order = DB::table('carts')->where('product_order', 'yes')->distinct() ->count('invoice_no');


            $processing_order=DB::table('carts')->where('product_order','approve')->distinct() ->count('invoice_no');

            $cancel_order=DB::table('carts')->where('product_order','cancel')->distinct() ->count('invoice_no');

            $complete_order=DB::table('carts')->where('product_order','delivery')->distinct() ->count('invoice_no');
    ...
    public function reservation_confirm(Request $req)
    {
        ...
        */
        ...
        ->setOptions(['isHtml5ParserEnabled' => true, 'isFontSubsettingEnabled' => true]);
